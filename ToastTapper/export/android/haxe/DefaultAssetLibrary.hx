...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/Toast.png", __ASSET__assets_images_toast_png);
		type.set ("assets/images/Toast.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/Toast.xcf", __ASSET__assets_images_toast_xcf);
		type.set ("assets/images/Toast.xcf", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		type.set ("assets/images/images-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("assets/images/Toast.png", "assets/images/Toast.png");
		type.set ("assets/images/Toast.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/Toast.xcf", "assets/images/Toast.xcf");
		type.set ("assets/images/Toast.xcf", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class __ASSET__assets_images_toast_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_toast_xcf extends null { }
